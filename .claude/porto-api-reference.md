# Porto API Reference - Documentation URLs

Quick reference for looking up official Porto SDK documentation.

## Base URLs

- **Porto Documentation**: `https://porto.sh/sdk`
- **Porto SDK**: Porto is a wallet abstraction SDK for building web3 applications with embedded wallets
...
- **Deploying to Production**: https://porto.sh/sdk/production
...
- Customizable theming for wallet UI components
- Fee sponsoring and gasless transactions
- Payment processing and subscriptions
- Permission management for wallet operations
- Guest mode for onboarding without immediate account creation
